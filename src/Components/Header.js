...
const Header = ()=>{
    return (
        <div className=" flex items-center justify-between px-3 shadow-xl">
            ...
            <div>
                <ul className="flex">
                    <li className="text-lg text-gray-400 mx-3 px-3 font-semibold hover:text-orange-600">Home</li>
                    ...
                    <li className="text-lg text-gray-400 mx-3 px-3 font-semibold hover:text-orange-600">Cart</li>
